...
public class AdjustableHood extends SubsystemBase {
  ...
  private final SparkMax hoodGear = new SparkMax(22, MotorType.kBrushless); // CAN ID is either 1 or 4, I had gotten the exact ID but my code didn't save and I had to manually redo it to push
